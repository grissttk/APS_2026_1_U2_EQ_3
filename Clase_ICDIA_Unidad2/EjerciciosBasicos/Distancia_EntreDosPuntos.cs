...
public class Distancia_EntreDosPuntos<T> : Ejercicio where T : INumber<T>
{
    Punto<T> punto1;
    Punto<T> punto2;
    ...
    public Distancia_EntreDosPuntos(T p1coordX, T p1coordY, T p2coordX, T p2coordY) : base (10, 
